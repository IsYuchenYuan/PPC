    ...
    for x in range(0, sx):
        ...
        for y in range(0, sy):
            ...
            for z in range(0, sz):
                ...
                outputs = net(test_patch)  # d,2,h,w
                y1 = outputs["proto_seg"]
...
@torch.no_grad()
def test_calculate_metric(net, image_list, num_classes=2, patch_size=(96, 96, 96)):
    avg_metric = test_all_case(net, image_list, num_classes=num_classes,
                               patch_size=patch_size, stride_xy=16, stride_z=4,
